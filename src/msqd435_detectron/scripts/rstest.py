...
if __name__ == '__main__':
    ...
    model = YoloV5(yolov5_yaml_path='/home/msq/catkin_ws/src/msqd435_detectron/scripts/config/yolov5s.yaml')
...
# 显示图形
           ...
           # print , camera_xyz_list[0]
#print "list1[0]: ", list1[0]（前面是地址、后面是值）
            # 添加fps显示
